...
/// Generate a sorting permutation based on offsets generated by \ref mkperm_phase_2() [shared memory]
KERNEL void mkperm_phase_2_shared(const uint32_t *values, const uint32_t *buckets,
...
/// Generate a sorting permutation based on offsets generated by \ref mkperm_phase_2() [global memory]
KERNEL void mkperm_phase_2_global(const uint32_t *values, uint32_t *buckets_,
