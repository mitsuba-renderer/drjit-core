...
L4:
  ...
  %r6 = tail call <16 x float> @llvm.x86.avx512.mask.gather.dps.512(<16 x float> undef, i8* %0, <16 x i32> %2, <16 x i1> %3, i32 4)
  %r7 = tail call <16 x i32> @llvm.x86.avx512.conflict.d.512(<16 x i32> %2)
...
L31:
  ...
  tail call void @llvm.x86.avx512.mask.scatter.dps.512(i8* %0, <16 x i1> %3, <16 x i32> %2, <16 x float> %r33, i32 4)
  ret void
}
...
L4:
  %r5 = bitcast <16 x i1> %3 to i16
  %r6 = tail call <16 x i32> @llvm.x86.avx512.mask.gather.dpi.512(<16 x i32> undef, i8* %0, <16 x i32> %2, <16 x i1> %3, i32 4)
  %r7 = tail call <16 x i32> @llvm.x86.avx512.conflict.d.512(<16 x i32> %2)
  %r8 = zext i16 %r5 to i32
  %r9 = insertelement <16 x i32> undef, i32 %r8, i32 0
  %r10 = shufflevector <16 x i32> %r9, <16 x i32> undef, <16 x i32> zeroinitializer
...
L31:
  ...
  tail call void @llvm.x86.avx512.mask.scatter.dpi.512(i8* %0, <16 x i1> %3, <16 x i32> %2, <16 x i32> %r33, i32 4)
  ret void
}
...
L4:
  ...
  %r6 = tail call <8 x double> @llvm.x86.avx512.mask.gather.qpd.512(<8 x double> undef, i8* %0, <8 x i64> %2, <8 x i1> %3, i32 8)
  %r7 = tail call <8 x i64> @llvm.x86.avx512.conflict.q.512(<8 x i64> %2)
...
L4:
  %r5 = bitcast <8 x i1> %3 to i8
  %r6 = tail call <8 x i64> @llvm.x86.avx512.mask.gather.qpq.512(<8 x i64> undef, i8* %0, <8 x i64> %2, <8 x i1> %3, i32 8)
  %r7 = tail call <8 x i64> @llvm.x86.avx512.conflict.q.512(<8 x i64> %2)
  %r8 = zext i8 %r5 to i64
  %r9 = insertelement <8 x i64> undef, i64 %r8, i32 0
  %r10 = shufflevector <8 x i64> %r9, <8 x i64> undef, <8 x i32> zeroinitializer
...
L31:
  ...
  tail call void @llvm.x86.avx512.mask.scatter.qpq.512(i8* %0, <8 x i1> %3, <8 x i64> %2, <8 x i64> %r33, i32 8)
  ret void
}
