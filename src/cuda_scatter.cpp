...
void jitc_cuda_render_scatter_inc(Variable *v, const Variable *ptr,
    ...
    fmt_intrinsic(
        ...
        "    .reg .b64 %ptr, %ptr_shift;\n"
        "    .reg .b32 %active, %ptr_id, %active_p,\n"
        "              %leader_idx, %lt_mask, %lane, %lt_active_p, %lt_ct,\n"
        ...
        "    mov.u32 %lane, %laneid;\n"
//        "    bfind.u32 %leader_idx, %active_p;\n"
//        "    setp.eq.u32 %leader, %leader_idx, %lane;\n"
        "    elect.sync %leader_idx|%leader, %active_p;\n"
